# A minimal Docker image with Node, Puppeteer, and Xvbf.
#
# References:
...
FROM --platform=linux/amd64 node:12-slim
...
# To avoid this, we will use Xvfb, and create a fake display, so Chrome will think there is a display and run properly.
